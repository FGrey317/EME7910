...
# and replace the "True" with "true"
#
# example Mutate
# mutate(event_data = gsub("True", "true", event_data))
# This W3schools page provides a simple approach to  for each row: https://www.w3schools.com/python/pandas/ref_df_iterrows.asp
...
dfMagnet <- mutate(dfMagnet, event_data = gsub("'", '"', event_data)) 

dfMagnet %>%  print()

dfMagnet <- mutate(dfMagnet, event_data = gsub("True", "true", event_data)) 
...
# How to add unique game IDs, coming soon.
# How to add unique game IDs, coming soon.
# How to add unique game IDs, coming soon.
# How to add unique game IDs, coming soon.
# How to add unique game IDs, coming soon.
